  ...
  return (
    <PageTransition>
      <PageHero
        ...
        description="Everything happening this week, day by day — tap a flier for a closer look where there is one. For anything time-sensitive, call the masjid directly."
